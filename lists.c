...
/**
 * node_end - adds a node at the end of the list
 * @head: address of pointer to head node
 * @str: string field of node
 * @num: node index used by history
 *
...
/**
 * print_list_string - prints only the string element of a linked list
...
/**
 * node_at_index_deleted - deletes node at a given index
 * @head: address of pointer to first node
 * @index: index of node to delete
 *
 * Return: success(1), failure(0)
 */
int node_at_index_deleted(list_t **head, unsigned int index)
{
...
/**
 * list_freed - frees all nodes of a list
