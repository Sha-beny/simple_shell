...
{
	custom_puts(info->filename);
	custom_puts(": ");
	print_dir(info->line_count, STDERR_FILENO);
	custom_puts(": ");
...
/**
 * print_dir - function prints a decimal (integer) number (base 10)
 * @input: the input
 * @fd: the file descriptor to write to
 *
 * Return: number of characters printed
 */
int print_dir(int input, int fd)
{
